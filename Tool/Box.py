...
class BoxDimensionDialog(TranslatedDialog):
...
class BoxEdgeDialog(TranslatedDialog):
    def __init__(self, parent=None):
...
class BoxLidDialog(TranslatedDialog):
    def __init__(self, parent=None):
    ...
    def create_perfect_fit_box(self, gap_w, gap_l, gap_h, wall_t, tolerance, edge_type, edge_size, lid_needed, lid_t):
        with Progress.ProgressManager() as bar:
            ...
            if lid_needed:
                ...
                obj_lid.ViewObject.ShapeColor = (0.2, 0.6, 0.8)
