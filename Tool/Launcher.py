...
RING_TOOL_INFO_LIST = [
    ...
    {"id": "Ring_Daiya", "name": "ダイヤモンドの生成", "desc": "ラウンドブリリアントカット(簡易)したダイヤモンドを生成します。これを指輪に付けることができます。"},
    {"id": "Ring_Connect", "name": "パーツ結合", "desc": "指輪にダイヤモンドを載せるための専用ツールです。"},
    {"id": "Ring_Weight", "name": "重量の自動計算", "desc": "作成した3Dモデルの体積から、各種金属（K18、Pt900、SV925など）や樹脂で作った場合の推定重量を計算します。"},
    {"id": "Ring_MakeJig", "name": "梱包補助", "desc": "生成したモデルに隙間を指定して体積を求めます。梱包する際に便利です。"},
    {"id": "Ring_Magatama", "name": "勾玉(まがたま)の生成", "desc": "日本の伝統的な勾玉形状のアクセサリーチャームやペンダントトップを作成します。"},
    {"id": "Ring_Suiteki", "name": "水滴・しずくパーツの生成", "desc": "みずみずしい丸みを持った水滴（ドロップ）形状のチャームを作成します。"},
    {"id": "Ring_Mikazuki", "name": "三日月パーツの生成", "desc": "おしゃれな三日月（ムーン）モチーフの立体3Dモデルを作成します。"},
    {"id": "Ring_Heart", "name": "ハートパーツの生成", "desc": "ぷっくりとした可愛らしい立体ハートモチーフを作成します。"},
    {"id": "Ring_Hoshi", "name": "星パーツの生成", "desc": "エッジの効いた立体的な5角星モチーフのチャームを作成します。"},
    {"id": "Ring_Inkan", "name": "印鑑・ハンコの作成", "desc": "任意の文字を入力して、オリジナルのスタンプ・印鑑の3Dモデルを作成します。"},
    {"id": "Ring_Button", "name": "ボタンの作成", "desc": "服飾用のボタン（2つ穴・4つ穴など）の形状やサイズを指定して生成します。"},
    {"id": "Ring_Mug", "name": "マグカップの作成", "desc": "持ち手がついた実用的なマグカップの3Dモデルを作成します。"},
    {"id": "Ring_Vase", "name": "花瓶の作成", "desc": "滑らかな曲線美を持つ花瓶や壺の3Dモデルを作成します。"},
    {"id": "Ring_Box", "name": "収納ボックスの作成", "desc": "アクセサリーや小物パーツを収納するためのフタ付きケースを作成します。"},
    {"id": "Ring_BatteryBox", "name": "電池ボックスの作成", "desc": "単3や単4などの各種規格電池を収納・固定するための電池ホルダーを作成します。"},
    {"id": "Ring_MakeSpoon", "name": "スプーンの作成", "desc": "皿部分の深さや柄の長さを調整してスプーンを作成します。"},
...
CONST_TOOL_INFO_LIST = [
    ...
    {"id": "Construction_MakeRoad", "name": "道路モデルの作成", "desc": "線形データや幅員・勾配パラメータに基づいて3D道路形状を生成します。"},
    {"id": "Construction_MakeTetrapod", "name": "消波ブロック(テトラポッド)", "desc": "海岸や河川工事で使用される標準的な消波ブロック（テトラポッド）の3Dモデルを作成します。"},
    {"id": "Construction_MakeExcelSurface", "name": "Excelデータからの3D地形作成", "desc": "ExcelのXYZ座標データを読み込み、点群から3D地形サーフェス（TIN/メッシュ）を自動構築します。"},
