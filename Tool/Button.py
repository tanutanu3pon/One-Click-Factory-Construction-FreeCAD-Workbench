...
class Tool_MakeButton:
    ...
    def create_clothing_button(self, d, t, hole_count, design_idx):
        with Progress.ProgressManager() as bar:
            ...
            elif design_idx == 3:  # 【新規1】クラシックボタン (段付きダブルリム)
            ...
            elif design_idx == 4:  # 【新規2】ヴィンテージボタン (ドーム盛り上がり)
            ...
            style_labels = ["Simple", "Stylish", "Cute", "Classic", "Vintage"]
